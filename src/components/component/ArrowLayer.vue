...
<template>
  <div class="arrow-layer">
    <div class="arrow-container" v-for="(obj,index) in stratagem" :key="index">
      <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 100 100" v-if="obj === Direction.UP">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 100 100" v-if="obj === Direction.DOWN">
        <path :style="fillArrowColor(index)" :class="{ 'error-arrow': errorIndex.includes(index) }" fill="#ffffff"
      ...
      <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 100 100" v-if="obj === Direction.LEFT">
        <path :style="fillArrowColor(index)" :class="{ 'error-arrow': errorIndex.includes(index) }" fill="#ffffff"
      ...
      <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 100 100" v-if="obj === Direction.RIGHT">
        <path :style="fillArrowColor(index)" :class="{ 'error-arrow': errorIndex.includes(index) }" fill="#ffffff"
